...
% %bot_d15n_sample(1:24,:) =  logsheet(185:208,2:s(2));
% bot_d15n_sample1(1:24,:) =  logsheet(236:259,2:s(2));
% bot_d15n_sample2(1:24,:) =  logsheet(261:284,2:s(2));
% bot_d15n_sample3(1:24,:) =  logsheet(286:309,2:s(2));
% 
% bot_i129_sample(1:24,:) =  logsheet(611:634,2:s(2));
% bot_u236_sample(1:24,:) =  logsheet(636:659,2:s(2));
% 
% %bot_dsi_sample(1:24,:) = logsheet(311:334,2:s(2));
% %bot_fdom_sample(1:24,:) =  logsheet(109:132,2:s(2));
% %bot_127i_sample(1:24,:) =  logsheet(93:103,2:s(2));
% 
% % One-off stuff:
% bot_lignin_sample(1:24,:) =  logsheet(311:334,2:s(2));
% bot_phytobac_sample(1:24,:) = logsheet(336:359,2:s(2));
% 
% bot_phagotrophy_sample1(1:24,:) = logsheet(361:384,2:s(2));
% bot_phagotrophy_sample2(1:24,:) = logsheet(386:409,2:s(2));
% bot_phagotrophy_sample3(1:24,:) = logsheet(411:434,2:s(2));
% 
% bot_dna_sample(1:24,:) = logsheet(461:484,2:s(2));
% bot_ratio_sample(1:24,:) = logsheet(486:509,2:s(2));
% 

% bot_photochem_sample2(1:24,:) = logsheet(536:559,2:s(2));
% 
% bot_photochem_sample3(1:24,:) = logsheet(561:584,2:s(2));
% bot_n2_fix_sample(1:24,:) = logsheet(586:609,2:s(2));

%bot_n2o_sample1(1:24,:) = logsheet(311:334,2:s(2));
%bot_n2o_sample2(1:24,:) = logsheet(336:359,2:s(2));
%bot_n2o_sample3(1:24,:) = logsheet(361:384,2:s(2));

%bot_ap_sample(1:24,:) = logsheet(386:409,2:s(2));
%bot_chla_sample(1:24,:) = logsheet(411:434,2:s(2));
%bot_tsm_sample(1:24,:) = logsheet(436:459,2:s(2));
...
filename = [path_out cruise '_bottle-v',num2str(version(1)),'.mat'];
